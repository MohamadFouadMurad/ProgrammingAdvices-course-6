// I learned how to manipulate strings dynamically using 'std::string' built-in methods, including structural queries (.length, .at), modifications (.append, .insert, .push_back, .pop_back, .clear), substring extraction (.substr), and pattern searching (.find) compared against 'std::string::npos'.
#include <iostream>
#include <string>
using namespace std;
...
int main()
{
	string S1 = "My Name is Mohamad fouad murad, I Love Programming.";
